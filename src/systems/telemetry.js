...
import { scanOrigin, liveTier, knownTier, TIER_NAME } from './scanner.js';
import { detectionRange, npcSignature } from './detection.js';
import { surveyLevel, planetInfo, asteroidDetail } from './survey.js';
...
export function orbitalPeriod(u) {
