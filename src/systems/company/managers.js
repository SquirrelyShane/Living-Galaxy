...
import { MANAGER_ARCHETYPES, AUTONOMY, archetypeFor } from '../../data/npc-kb/managers.js';
import { FACILITIES } from '../../data/planetary/index.js';
import { siteById, sites, powerSatisfaction, powerDraw, powerSupply,
         stored, storageCap, workforce, installFacility, toggleFacility } from '../industry/planetary.js';
