...
import { holdOf, holdCap, holdMass, loadHold, unloadHold } from './holds.js';
...
import { fieldContacts, fieldPoint } from './fields.js';
import { nearestAsteroid, mineAsteroid } from '../world/asteroids.js';
import { transmit } from './comms.js';
import { planRoute, routeClear, segmentDistance } from './navplan.js';
import { wellRadius, inGravityWell } from './warp.js';
import { projects, nextProject, advanceProject, completeProject } from './fleet-projects.js';
import { deliverToSite } from './worldsim.js';
 ...
 */
export function assignExtraction(order, ship) {
