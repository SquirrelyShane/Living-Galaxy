...
> Known stale here: **slice 11 "Standing" was proposed for v1.01.90 and was not built** —
> that version shipped "Work Orders" instead. Slices 11-13 are all unstarted. Gossip
> propagation, listed inside slice 11, already exists (`systems/npc-comms.js:175,219`).
