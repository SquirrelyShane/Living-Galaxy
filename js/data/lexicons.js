...
export const LEXICONS = {
  ...
  haask: {
    ...
    mark: "'", pMark: 0.25,
    /* 0.3.54: five endings a gender made a Haask crew one name five times */
    end: {
      f: ["aa", "ish", "saa", "ika", "esh", "ithe", "ka", "ssa", "ez"],
      m: ["ask", "ess", "kaa", "ith", "urs", "ak", "ot", "esk", "is"],
      n: ["", "sk", "aa", "ith", "zt", "ik", "ess", "ot"],
    },
  ...
  veyd: {
    ...
    ban: /[bcdgkpqtx]/,
      ...
      f: ["ae", "eya", "iel", "ys", "aeth", "ira", "esse", "wyn", "ali"],
      m: ["eyn", "ael", "ivo", "esh", "oen", "yr", "anel", "own", "ros"],
      n: ["", "ey", "ael", "ynn", "aeth", "ioe", "ir", "ess"],
    },
    family: { kind: "none" },
  },
